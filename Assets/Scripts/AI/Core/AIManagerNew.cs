...
namespace AI.Core
{
    ...
    public class AIManagerNew : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (_hexGrid == null)
            {
                ...
                if (_hexGrid == null)
                {
                    Debug.LogError("[AIManagerNew] No HexGrid found in scene!");
                    enabled = false;
                    return;
                }
            }
            ...
            {
                Debug.LogWarning("[AIManagerNew] AIServiceContainer not found - some features may be limited");
            }
        }
        ...
        private void Start()
        {
            ...
            {
                Debug.Log($"[AIManagerNew] Initialized with {_botRegistry.RegisteredBots.Count} bots " +
        ...
        public bool RegisterBot(NewAIEnemy aiBot)
        {
            ...
            if (registered && _hexGrid != null)
            {
                ...
                try
                {
                    ...
                    if (_enableGlobalDebug)
                        Debug.Log($"[AIManagerNew] Bot {aiBot.name} registered and initialized");
                }
                catch (System.Exception ex)
                {
                    Debug.LogError($"[AIManagerNew] Failed to initialize registered bot {aiBot.name}: {ex}");
                }
            }
        ...
        public void RefreshSystem()
        {
            ...
            if (_enableGlobalDebug)
                Debug.Log("[AIManagerNew] System refreshed manually");
        }
        ...
        public void SetUpdateInterval(float interval)
        {
            ...
            if (_enableGlobalDebug)
                Debug.Log($"[AIManagerNew] Update interval set to {_updateInterval}s");
        }
        ...
        private bool ValidateComponents()
        {
            if (_botRegistry == null)
            {
                Debug.LogError("[AIManagerNew] No AIBotRegistry component found!");
                return false;
            }

            if (_statisticsCollector == null)
            {
                Debug.LogError("[AIManagerNew] No AIStatisticsCollector component found!");
                return false;
            }
        ...
        private void InitializeAISystem()
        {
            ...
            if (_enableGlobalDebug)
            {
                ...
                Debug.Log($"[AIManagerNew] AI System initialized: {initializedCount} bots, services {servicesStatus}");
            }
        }
        ...
        private void UpdateAISystem()
        {
            ...
            if (_botRegistry.HasCharacterCountChanged())
            {
                ...
                if (_enableGlobalDebug)
                    Debug.Log("[AIManagerNew] Character count changed, lists refreshed");
            }
        ...
        private void OnInternalCharactersUpdated(System.Collections.Generic.List<ICharacter> characters)
        {
            ...
            if (_enableGlobalDebug)
                Debug.Log($"[AIManagerNew] Characters updated: {characters.Count} total");
        }
        ...
        private void InspectorPrintStatus()
        {
            ...
            var report = "[AIManagerNew] System Status:\n";
        ...
        private void InspectorTestServices()
        {
            ...
            if (container == null)
            {
                Debug.LogError("[AIManagerNew] No AIServiceContainer found!");
                return;
            }

            var report = "[AIManagerNew] Service Integration Test:\n";
        ...
        private void InspectorToggleDebug()
        {
            ...
            Debug.Log($"[AIManagerNew] Global debug {(_enableGlobalDebug ? "enabled" : "disabled")}");
        }
